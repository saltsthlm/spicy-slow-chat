    ...
    <div className="flex flex-col w-[85%]">
      {messages.map((message) => {
        if (message.username === "John Wick") {
          return (
            <div
              className="bg-primary text-primary-foreground rounded-lg px-3 py-1 text-sm my-2 self-end"
        ...
        return (
          <div
            className="bg-secondary text-primary rounded-lg px-3 py-1 text-sm my-2 self-start"
            key={message.timestamp}
          >
